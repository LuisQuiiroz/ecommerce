...
export function ContentItem ({ product, nameCompany }) {
  ...
  return (
    <div className='p-6'>
      <h3 className='uppercase text-cus-primary font-k-bold text-sm'>{nameCompany}</h3>
              ...
              ? (
                <div className='flex md:block items-center justify-between my-6 font-k-bold'>
                  <p className='flex items-center text-3xl '>
                    ...
                    <span className=' text-base ml-4 text-cus-primary bg-cus-pale-primary px-2 rounded-md'>
                      {discountRate}
                    </span>
                  </p>
      ...
      <div className='md:flex md:gap-4 xl:gap-8'>
        <div className='md:w-1/2 lg:w-1/3 flex justify-between items-center my-4 md:my-0 font-k-bold '>
          <button
            className='text-3xl bg-white flex justify-center items-center p-1 rounded-full text-cus-primary hover:opacity-70'
